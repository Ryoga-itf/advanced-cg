...
void Scene02ImageSmoothing::Init() {
    ...
    Image2OGLTexture(finder.find("kitten.jpg").c_str(), s_TexID, s_TexWidth, s_TexHeight, GL_TEXTURE_2D, GL_LINEAR,
                     GL_MIRRORED_REPEAT);
}
...
void Scene02ImageSmoothing::Resize(GLFWwindow *window, int w, int h) { AbstractScene::Resize(window, w, h); }
