...
GLSLShaderObject::~GLSLShaderObject() { glDeleteShader(handle_); }
...
GLuint GLSLShaderObject::getHandle() const { return handle_; }

void GLSLShaderObject::getParameter(GLenum param, GLint *data) const { glGetShaderiv(handle_, param, data); }
