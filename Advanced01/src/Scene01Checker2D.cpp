...
ImVec4 Scene01Checker2D::s_CheckerColor1 = ImVec4(79.f / 255.f, 172.f / 255.f, 135.f / 255.f, 0);
...
void Scene01Checker2D::ReloadShaders() {
    ...
    glVertexAttribPointer(inTexCoordLocation, 2, GL_FLOAT, GL_FALSE, 0,
...
void Scene01Checker2D::Draw() {
    ...
    s_pShader->use();
    s_pShader->sendUniform4f("checkerColor0", s_CheckerColor0.x, s_CheckerColor0.y, s_CheckerColor0.z,
                             s_CheckerColor0.w);
    s_pShader->sendUniform4f("checkerColor1", s_CheckerColor1.x, s_CheckerColor1.y, s_CheckerColor1.z,
                             s_CheckerColor1.w);
    s_pShader->sendUniform2f("checkerScale", s_CheckerScale.x, s_CheckerScale.y);
...
void Scene01Checker2D::Resize(GLFWwindow *window, int w, int h) { AbstractScene::Resize(window, w, h); }
